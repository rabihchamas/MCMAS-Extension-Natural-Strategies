...
extern "C++" {
  ...
  BDD check_ATLX(BDD next, string grpname, bdd_parameters *para);
    ...
    vector<BDD> vectNat(BDD q1,  string grpname, bdd_parameters *para);
    BDD check_ATLU_Nat(BDD q1, BDD q2, string grpname, bdd_parameters *para);
    BDD check_ATLF_Nat(BDD q1, string grpname, bdd_parameters *para);
    BDD check_ATLX_Nat(BDD next, string grpname, bdd_parameters *para);
    ...
    int cmplxNatStr1(BDD q1,vector<BDD>* res, string grpname, bdd_parameters * para);
    vector<BDD> MintermsProp(vector<BDD> *w,bdd_parameters *para);
    int cmplxNatStr(BDD q1, BDD q2,vector<BDD>* res, string grpname, bdd_parameters * para);
    vector<BDD> vectMinterms(BDD form,vector<BDD> *w,bdd_parameters *para );
    vector<BDD> vectCubes(BDD form,bdd_parameters *para );
    int cmplxCube(BDD cube,bdd_parameters *para);
    int cmplxform(BDD form,bdd_parameters *para);
    int cmplxformProp(BDD form,vector<BDD> *w,bdd_parameters *para);
    int cmplxCubeProp(BDD cube,vector<BDD> *w ,vector<string> A,bdd_parameters *para);
    vector<BDD> vectCubesProp(BDD form, vector<BDD> *w, bdd_parameters *para);
    vector<BDD> Mintermsform(BDD form, vector<BDD> *w,bdd_parameters *para);
    BDD ExistAbstractProp(BDD var, BDD form, vector<BDD> *w, bdd_parameters *para);
    vector<BDD> PrimeImplicants(BDD form, vector<BDD> *w, bdd_parameters *para);
    vector<BDD> check_ATLF_Nat_vect(BDD q1, string grpname, bdd_parameters * para);
    vector<vector<BDD>> vecvectNat(BDD q1, string grpname, bdd_parameters * para);
